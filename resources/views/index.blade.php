...
<body>
	...
	<div class="banner" id="home">
		<div class="container">
			<div class="banner-text">
				...
				<h1 class="text-uppercase">Bienvenido Nakama</h1>
					<p class="text-white">Bienvenido a nuestro Sitio Sobre el Manga Shonen Mas vendido de la Historia
					Una historia que con 25 Anos de Longevidad, Sigue guardando incontables misterios, VAMOS A DESCUBRIRLOS!</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="cpy-right text-center">
		<p>Sebastian Ramirez:
			<a href="mailto:sebastian.ramirezar@upb.edu.co">sebastian.ramirezar@upb.edu.co</a>
		</p>
		<p>Sebastian Aristizabal:
			<a href="mailto:sebastianaritizabal@upb.edu.co">sebastian.aristizabal@upb.edu.co</a>
		</p>
	</div>
	<!-- //copyright -->
	<!-- js-->
